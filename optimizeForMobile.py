...
input_graph_path = './save/mobilernn.pbtxt'
checkpoint_path = './save/mobilernn.ckpt'
input_saver_def_path = ""
input_binary = False
output_node_names = "probs"
restore_op_name = "save/restore_all"
filename_tensor_name = "save/Const:0"
output_frozen_graph_name = "frozen_model_mobile.pb"
output_optimized_graph_name = "rnn_optimized_model_mobile.pb"
clear_devices = True
